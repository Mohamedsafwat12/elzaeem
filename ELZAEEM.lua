...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./ELZAEEM.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S ELZAEEM -X kill
screen -S ELZAEEM ./ELZAEEM
done
]])  
file:close() 
...
--------------------------------------------------------------------------------------------------------------
print([[
_____ _     _____   _    _____ _____ __  __
| ____| |   |__  /  / \  | ____| ____|  \/  |
|  _| | |     / /  / _ \ |  _| |  _| | |\/| |
| |___| |___ / /_ / ___ \| |___| |___| |  | |
|_____|_____/____/_/   \_\_____|_____|_|  |_|
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ELZAEEMTEAM/Files_ELZAEEM/master/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevELZAEEMW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevELZAEEMW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevELZAEEMW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevELZAEEMW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevELZAEEMW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevELZAEEMW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevELZAEEMW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1458090052) then
var = true  
...
local ELZAEEM_Msg = ''  
if msgs < 100 then 
ELZAEEM_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
ELZAEEM_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
ELZAEEM_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
ELZAEEM_Msg = 'متفاعل' 
elseif msgs < 1200 then 
ELZAEEM_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
ELZAEEM_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
ELZAEEM_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
ELZAEEM_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
ELZAEEM_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
ELZAEEM_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
ELZAEEM_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
ELZAEEM_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
ELZAEEM_Msg = 'رب التفاعل'  
end 
return ELZAEEM_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@M_W_12")  
...
--------------------------------------------------------------------------------------------------------------
function SourceELZAEEM(msg,data) -- بداية العمل
if msg then
...
if start then 
SourceELZAEEMr = start
else
SourceELZAEEMr = '❃∫ اهلا عزيزي\n ❃∫ انا بوت اسمي '..Namebot..'\n ❃∫ اختصاصي حمايه الجروبات\n ❃∫ من تكرار والسبام والتوجيه والخ…\n ❃∫ لتفعيلي اتبع الاخطوات…↓\n ❃∫ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ❃∫ [قناة سورس البوت](http://t.me/E_L_A_M_E_R)'
end 
send(msg.chat_id_, msg.id_, SourceELZAEEMr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevELZAEEMW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevELZAEEMW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,ELZAEEM_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevELZAEEMW(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevELZAEEMW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevELZAEEMW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevELZAEEMW(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevELZAEEMW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❃∫ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevELZAEEMW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevELZAEEMW(msg) then 
...
if text == 'تحديث السورس ❃' and DevELZAEEMW(msg) then 
os.execute('rm -rf ELZAEEM.lua')
os.execute('wget https://raw.githubusercontent.com/ELZAEEMTEAM/ELZAEEM/master/ELZAEEM.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس الزعيم\n ❃∫ الاصدار » { 1.3v}')
dofile('ELZAEEM.lua')  
end
if text == 'الاصدار ❃' and DevELZAEEMW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس الزعيم \n ❃∫ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❃' and DevELZAEEMW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/E_L_A_M_E_R) \n ❃∫ [قناه السورس](t.me/E_L_A_M_E_R)')
end
if text == "ضع اسم للبوت ❃" and DevELZAEEMW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevELZAEEMW(msg) then 
...
if text == 'المشتركين ❃' and DevELZAEEMW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات ❃' and DevELZAEEMW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الجروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevELZAEEMW(msg) then
...
if text == ("قائمه العام ❃") and DevELZAEEMW(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevELZAEEMW(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevELZAEEMW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevELZAEEMW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevELZAEEMW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevELZAEEMW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevELZAEEMW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❃' and DevELZAEEMW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevELZAEEMW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الجروبات ❃" and DevELZAEEMW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الجروبات الان » { '..#group..' }'..ELZAEEMk..''..ELZAEEM..'\n❃∫  الان عدد الجروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevELZAEEMW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevELZAEEMW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevELZAEEMW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevELZAEEMW(msg) then
...
local ELZAEEM1_Msg = database:get(bot_id.."ELZAEEM1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ELZAEEM1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if ELZAEEM_Msg and not Special(msg) then  
local ELZAEEM_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ELZAEEM_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevELZAEEMW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevELZAEEMW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevELZAEEMW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevELZAEEMW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevELZAEEMW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❃∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevELZAEEMW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevELZAEEMW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevELZAEEMW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❃∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevELZAEEMW(msg) then  
...
database:sadd(bot_id.."ELZAEEM:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."ELZAEEM:blocname"..msg.chat_id_)
...
function M_W_12_name(t1,t2)
if t2.id_ then 
name_ELZAEEM = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_ELZAEEM then 
names_ELZAEEM = database:smembers(bot_id.."ELZAEEM:blocname"..msg.chat_id_) or ""
if names_ELZAEEM and names_ELZAEEM[1] then 
for i=1,#names_ELZAEEM do 
if name_ELZAEEM:match("(.*)("..names_ELZAEEM[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, M_W_12_name)
end
...
database:set(bot_id.."ELZAEEM:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."ELZAEEM:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."ELZAEEM:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."ELZAEEM:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."ELZAEEM:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_ELZAEEMa_new(ELZAEEM1,ELZAEEM2)
if ELZAEEM2 and ELZAEEM2.first_name_ then 
if ELZAEEM2.first_name_:match("(.*)"..database:get(bot_id.."ELZAEEM:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ELZAEEM:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local ELZAEEM_nnn = database:get(bot_id.."ELZAEEM:nump"..msg.chat_id_) or 5
local ELZAEEM_nnn2 = database:get(bot_id.."ELZAEEM:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(ELZAEEM_nnn2) == tonumber(ELZAEEM_nnn) or tonumber(ELZAEEM_nnn2) > tonumber(ELZAEEM_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."ELZAEEM:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..ELZAEEM2.username_.."](https://t.me/"..(ELZAEEM2.username_ or "E_L_A_M_E_R")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ELZAEEM:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(ELZAEEM_nnn) - tonumber(ELZAEEM_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_ELZAEEMa_new)
end
end
...
local ELZAEEMChengName = database:get(bot_id.."ELZAEEM:Cheng:Name"..data.id_)
if not data.first_name_ then 
if ELZAEEMChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..ELZAEEMChengName..']')
database:del(bot_id.."ELZAEEM:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if ELZAEEMChengName ~= data.first_name_ then 
local Text = {
  "ياولا غيرت اسمك ",
...
database:set(bot_id.."ELZAEEM:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local ELZAEEMChengUserName = database:get(bot_id.."ELZAEEM:Cheng:UserName"..data.id_)
if not data.username_ then 
if ELZAEEMChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..ELZAEEMChengUserName..']')
database:del(bot_id.."ELZAEEM:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if ELZAEEMChengUserName ~= data.username_ then 
local Text = {
...
'ها ياولا ليه مغير معرفك بيش مشتري يول', 
"منور معرف جديد :  "..data.username_.."",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."ELZAEEM:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local ELZAEEMChengPhoto = database:get(bot_id.."ELZAEEM:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if ELZAEEMChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."ELZAEEM:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if ELZAEEMChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  "ليه غيرت صورتك يا لئيم",
  "منور طالع حلو ع صوره جديده",
  "ها ياولا ليه غيرت صورتك😍😂",
...
database:set(bot_id.."ELZAEEM:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
  ...
  ↬ .ELZAEEM TEAM  
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
  ↬ . [Channel](t.me/E_L_A_M_E_R)  
  
  ↬ . [DEVELOPER](t.me/M_W_12)       
   
  ↬ . [Information](t.me/E_L_A_M_E_R) 
   
  ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉  
  ↬ . [TWS ](t.me/Mohamed_76_Bot )
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == 'رفع نسخه الاحتياطيه' and DevELZAEEMW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevELZAEEMW(msg) then    
dofile('ELZAEEM.lua')  
send(msg.chat_id_, msg.id_, ' ❃∫ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevELZAEEMW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevELZAEEMW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevELZAEEMW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevELZAEEMW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevELZAEEMW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevELZAEEMW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevELZAEEMW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevELZAEEMW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevELZAEEMW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevELZAEEMW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevELZAEEMW(msg) then
...
if database:get(bot_id.."M_W_12:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'M_W_12:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."M_W_12:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'M_W_12:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == 'الملفات' and DevELZAEEMW(msg) then
t = ' ❃∫ ملفات السورس الزعيم ↓\n≪━━━━━━𝐄𝐥 𝐙𝐀𝐄𝐄𝐌 ━━━━━━≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevELZAEEMW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ELZAEEMTEAM/Files_ELZAEEM/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات الزعيم\n ❃∫ ملفات السورس ↓\n≪━━━━━━𝐄𝐥 𝐙𝐀𝐄𝐄𝐌 ━━━━━━≫\n\n"
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevELZAEEMW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ELZAEEMTEAM/Files_ELZAEEM/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('ELZAEEM.lua')  
else
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس الزعيم \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevELZAEEMW(msg) then
...
if text == "مسح الملفات" and DevELZAEEMW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ❃∫ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevELZAEEMW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevELZAEEMW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "E_L_A_M_E_R")
...
function Function_ELZAEEM(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ELZAEEM, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_ELZAEEM, nil)
return false 
end
...
database:set(bot_id.."ELZAEEM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ELZAEEM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."ELZAEEM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ELZAEEM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ELZAEEM1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ELZAEEM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."ELZAEEM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ELZAEEM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ELZAEEM1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ELZAEEM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."ELZAEEM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ELZAEEM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ELZAEEM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ELZAEEM1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ELZAEEM1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ELZAEEM1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ELZAEEM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ELZAEEM1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ELZAEEM1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━𝐄𝐥 𝐙𝐀𝐄𝐄𝐌 ━━━━━━≫\n"
for k,v in pairs(list) do  
local ELZAEEM_Msg = database:get(bot_id.."ELZAEEM1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..ELZAEEM_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevELZAEEMW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevELZAEEMW(msg) then
...
if text == 'تفعيل الاذاعه' and DevELZAEEMW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevELZAEEMW(msg) then  
...
if not database:get(bot_id..'M_W_12:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'M_W_12:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'الزعيم').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'الزعيم')
local ELZAEEM_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..ELZAEEM_Msg[math.random(#ELZAEEM_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevELZAEEMW(msg) then 
...
if text == ("مسح ردود المطور") and DevELZAEEMW(msg) then 
...
if text == ("ردود المطور") and DevELZAEEMW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❃∫ قائمة ردود المطور \n≪━━━━━━𝐄𝐥 𝐙𝐀𝐄𝐄𝐌 ━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevELZAEEMW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevELZAEEMW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'الزعيم').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevELZAEEMW(msg) then   
...
if text == 'تعطيل المغادره' and DevELZAEEMW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ELZAEEM')..') '
...
-- vardump(data) 
ELZAEEMdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevELZAEEMW(msg) then
...
*❃م10 ◂ اوامر الاعضاء*
ٴ≪━━━━━━𝐄𝐥 𝐙𝐀𝐄𝐄𝐌 ━━━━━━≫ٴ
彡 .[El ZAEEM 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/E_L_A_M_E_R)➢ 
]]
...
zh = https.request('https://rudi-dev.tk/Amir1/ELZAEEM.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━𝐄𝐥 𝐙𝐀𝐄𝐄𝐌 ━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━𝐄𝐥 𝐙𝐀𝐄𝐄𝐌 ━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/E_L_A_M_E_R)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/ELZAEEM.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/ELZAEEM.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'الزعيم')
...
ELZAEEM = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ELZAEEM)
...
--------------------------------------------------------------------------------------------------------------
SourceELZAEEM(data.message_,data)
...
------------------------------------------------------------------------
local ELZAEEMAbot = database:get(bot_id.."ELZAEEM1:Add:Filter:Rp2"..text..result.chat_id_)   
if ELZAEEMAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..ELZAEEMAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local ELZAEEM1_Msg = database:get(bot_id.."ELZAEEM1:Add:Filter:Rp2"..text..result.chat_id_)   
if ELZAEEM1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..ELZAEEM1_Msg)
